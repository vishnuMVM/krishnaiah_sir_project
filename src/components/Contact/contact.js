            ...
            <div className="htr-main-container">
                ...
                <div className="htr-row-container">
                    <div className="htr-each-container">
                        ...
                        <p>Any piligrim who is too far from temple location wants to 
                            come by flight, renigunta is the nearest airport to take on.
                            followed by a road journey from renigunta
                        </p>
                    </div>
                    ...
                    <div className="htr-each-container">
                        ...
                        <p>Pudi Rail Way Station ,Taduku Rail Way Station are the very nearby railway stations to Vadamalpet
                            Also you can consider railway Stations from Near By town Chittoor. Chittoor Rail Way Station , Siddampalli Rail Way Station are the railway Stations near to Chittoor.
                            You can reach from Chittoor to Vadamalpet by road after.</p>
                    </div>
                    ...
                    <div className="htr-each-container">
                        ...
                        <p>P.R.Palli APSRTC Bus Station , Tirupathi APSRTC Bus Station , 
                            Puttur APSRTC Bus Station are the nearby by Bus Stations to Vadamalpet.
                            APSRTC runs Number of busses from major cities to here.</p>
                    </div>
                </div>
